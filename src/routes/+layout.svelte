...
<footer class="bg-base-300 flex flex-col items-center md:flex-row">
	...
	<div class="flex flex-row flex-wrap gap-3">
		...
		<button class="btn btn-ghost">
			<svg
				class=" fill-base-content h-5 w-5"
		...
		<button class="btn btn-ghost">
			...
			>
				<path
					d="M2.66464 15.9354H5.99797V9.26038H9.0013L9.3313 5.94372H5.99797V4.26872C5.99797 4.0477 6.08577 3.83574 6.24205 3.67946C6.39833 3.52318 6.61029 3.43538 6.8313 3.43538H9.3313V0.102051H6.8313C5.72623 0.102051 4.66643 0.541038 3.88502 1.32244C3.10362 2.10384 2.66464 3.16365 2.66464 4.26872V5.94372H0.997969L0.667969 9.26038H2.66464V15.9354Z"
				></path>
			</svg>
		</button>
